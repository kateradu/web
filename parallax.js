...
ParallaxPart = (function() {
    ...
    ParallaxPart.prototype.setYTransform = function(val) {
        this.el.style.webkitTransform = 'translate3d(0, ' + val + 'vh, 0)';
        this.el.style.MozTransform = 'translate3d(0, ' + val + 'vh, 0)';
        this.el.style.OTransform = 'translate3d(0, ' + val + 'vh, 0)';
        this.el.style.transform = 'translate3d(0, ' + val + 'vh, 0)';
        this.el.style.msTransform = 'translateY(' + val + 'vh)';
    };
